...
class RealmManager: NSObject {
    ...
    static let group = "group.com.git-sample-ios"
    static let indentifier = "group.com.git-sample-ios"
    ...
    class func getRealm() -> Realm {
        ...
        do {
            ...
            do {
                ...
                fatalError("Realm not installed")
            }
        }
    }
    ...
    fileprivate class func getKey() -> NSData {
        ...
        if status == errSecSuccess {
            return dataTypeRef as? NSData ?? NSData()
        }
